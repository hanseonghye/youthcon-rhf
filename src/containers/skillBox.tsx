...
const SkillBox = ({ control }: Props) => (
  <Grid item css={skilBoxLayout}>
    ...
    {/*<Autocomplete*/}
    {/*  renderInput={(params) => (*/}
    {/*    <TextField {...params} variant="standard" placeholder="보유 스킬을 검색해주세요." InputProps={{ endAdornment: <SearchIcon /> }} fullWidth />*/}
    {/*  )}*/}
    {/*  options={[]}*/}
    {/*  css={autoCompleteSearchField}*/}
    {/*  fullWidth*/}
    {/*/>*/}
    <Controller
      control={control}
